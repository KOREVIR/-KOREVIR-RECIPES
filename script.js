// ===== KOREVIR RECIPES - 50 RECIPES (GÖRSELLER .PNG UYUMLU) =====
...
const RECIPES = [
    ...
    // 4
    {
        ...
        method: [
            'Beat butter, sugar, vanilla. Add eggs. Fold in flour, milk. Bake 180°C 30-35 min. Cool. Make sauce: sugar, cocoa, butter, milk. Heat until smooth. Cut cake into squares. Dip in sauce, roll in coconut.'
        ]
    },
    // 5
    {
    ...
    // 8
    {
        ...
        method: [
            'Mix mince with sauces, season. Form patties. Grill 3-4 min each side, add cheese. Toast buns. Assemble with veggies, patty. Serve with chips.'
        ]
    },
    // 9
    {
