// ===== KOREVIR – PREMIUM SCRIPT (50 TARİF + TÜM FONKSİYONLAR) =====
...
const RECIPES = [
    // 1
    {
        ...
        method: [
            'Preheat oven to 200°C. Season chicken, coat in flour, egg, breadcrumbs. Fry until golden. Top with sauce and cheese. Bake 20-25 minutes.'
        ]
    },
    // 2
    {
        ...
        method: [
            'Cook onion, garlic, carrot, celery. Add beef mince and brown. Stir in tomato paste, stock, Worcestershire sauce, thyme. Simmer 10-15 min. Cool. Fill pastry, top with lid, brush with egg. Bake 200°C 20-25 min.'
        ]
    },
    // 3
    {
        ...
        method: [
            'Season fish. Pan-fry skin-side down 4-5 min, flip 2-3 min. Remove. In same pan, melt butter, garlic, lemon juice, zest, capers. Return fish, spoon sauce. Garnish with parsley.'
        ]
    },
    // 4
    {
        ...
        ingredients: [
            ...
            '125g butter (for sauce)',
            '1 cup milk (for sauce)',
            '1 tsp vanilla (for sauce)',
            '2 cups desiccated coconut'
        ],
        method: [
            'Beat butter, sugar, vanilla. Add eggs. Fold in flour, milk. Bake 180°C 30-35 min. Cool. Make sauce: sugar, cocoa, butter, milk. Heat until smooth. Cut cake, dip in sauce, roll in coconut.'
        ]
    },
    // 5
    {
        ...
        method: ['Toast bread. Spread butter and Vegemite. Serve.']
    },
    // 6
    {
        id: 'pavlova',
        ...
        method: [
            'Beat egg whites to soft peaks. Gradually add sugar. Fold in vinegar, cornstarch, vanilla. Bake 120°C 75-90 min. Cool. Top with cream and fruits.'
        ]
    },
    // 7
    {
        ...
        method: [
            'Cut potatoes into chips. Fry at 160°C 5-6 min, then 180°C 4-5 min. Batter fish, fry 4-5 min. Serve with tartare sauce.'
        ]
    },
    // 8
    {
        ...
        ingredients: [
            ...
            '4 burger buns',
            '4 cheese slices',
            'Lettuce, tomato, onion, beetroot',
            '4 tbsp burger sauce',
            '4 potatoes (for chips)'
        ],
        method: [
            'Mix mince with sauces. Form patties. Grill 3-4 min each side, add cheese. Toast buns. Assemble with veggies, patty. Serve with chips.'
        ]
    },
    // 9
    {
        ...
        method: [
            'Cook onion, garlic. Add beef, brown. Stir in sauces, thyme. Cool. Cut pastry, fill, seal with egg. Brush with egg, sprinkle sesame. Bake 200°C 20-25 min.'
        ]
    },
    // 10
    {
        ...
        method: [
            'Toss prawns with lemon juice. Mix mayonnaise, tomato sauce, Worcestershire sauce, paprika. Chill. Serve over lettuce with sauce, garnish with lemon and parsley.'
        ]
    },
    // 11
    {
        ...
        method: [
            'Pound chicken to even thickness. Coat in flour, egg, breadcrumb mixture. Pan-fry 3-4 min each side. Serve with lemon wedges.'
        ]
    },
    // 12
    {
        ...
        method: [
            'Boil and mash potatoes. Mix with flour, cornflour, egg, salt, pepper. Shape into patties. Coat in flour, egg, breadcrumbs. Shallow fry 3-4 min each side.'
        ]
    },
    // 13
    {
        ...
        method: [
            'Rub lamb with garlic, rosemary, oil, salt, pepper. Place on onion in roasting pan. Roast 200°C 20 min, then 165°C for 1-1.25 hours. Rest 15 min before carving.'
        ]
    },
    // 14
    {
        ...
        method: [
            'Season fish. Mix macadamias, panko, Parmesan, parsley, zest, mayonnaise. Press onto fish. Bake 200°C 15-18 min.'
        ]
    },
    // 15
    {
        ...
        method: [
            'Sauté onion, garlic. Add pumpkin, stock. Simmer 20 min. Blend until smooth. Stir in cream, season with salt, pepper, nutmeg.'
        ]
    },
    // 16
    {
        ...
        method: [
            'Mash bananas. Mix with oil, sugar, eggs, vanilla. Fold in flour, baking soda, salt, cinnamon. Bake 175°C 50-60 min.'
        ]
    },
    // 17
    {
        ...
        method: [
            'Marinate steaks 30 min. Grill 2-3 min each side for medium-rare. Rest 5 min. Serve with lemon wedges.'
        ]
    },
    // 18
    {
        ...
        method: [
            'Make dough, rise 1 hour. Roll out, spread Vegemite, sprinkle cheese. Roll up, cut into 12. Bake 180°C 18-20 min.'
        ]
    },
    // 19
    {
        ...
        method: [
            'Cook onion, garlic, chilli. Add tomatoes, capsicum, vinegar, sugar, salt, mustard seeds. Simmer 40-50 min until thick. Jar and seal.'
        ]
    },
    // 20
    {
        ...
        method: [
            'Base: crush biscuits, mix with butter, press. Chill. Caramel: heat condensed milk, butter, syrup until thick. Pour over base. Chill. Topping: melt chocolates with oil. Pour over. Chill. Cut into slices.'
        ]
    },
    // 21
    {
        ...
        method: [
            'Heat oil and 2 tbsp butter. Sauté garlic, chilli. Add prawns, cook 2-3 min each side. Add remaining butter, lemon juice. Season, garnish with parsley.'
        ]
    },
    // 22
    {
        ...
        method: [
            'Toss chicken with dressing and Parmesan. Place on tortillas with lettuce. Roll tightly, slice, and serve.'
        ]
    },
    // 23
    {
        ...
        method: [
            'Season fish. Grill 5-6 min each side. Serve with lemon wedges.'
        ]
    },
    // 24
    {
        ...
        method: [
            'Mix all ingredients. Shape into patties. Fry 4-5 min each side.'
        ]
    },
    // 25
    {
        ...
        method: [
            'Mix all ingredients. Drop spoonfuls into hot oil. Fry until golden.'
        ]
    },
    // 26
    {
        ...
        method: [
            'Mix flour, salt. Rub in butter. Add milk and water to form dough. Bake 200°C 25-30 min.'
        ]
    },
    // 27
    {
        ...
        method: [
            'Mix dry ingredients. Melt butter, syrup, soda, water. Combine. Drop spoonfuls onto tray. Bake 160°C 15 min.'
        ]
    },
    // 28
    {
        ...
        method: [
            'Brown beef. Sauté onion, carrot, garlic. Add beef, Guinness, stock, tomato paste. Simmer 2 hours. Cool. Fill pastry, top with lid, brush with egg. Bake 200°C 25-30 min.'
        ]
    },
    // 29
    {
        ...
        method: [
            'Toss squid in cornflour, salt, pepper. Deep fry 2-3 min. Serve with lemon.'
        ]
    },
    // 30
    {
        ...
        method: [
            'Marinate chicken 30 min. Grill skewers 5-6 min. Serve with satay sauce.'
        ]
    },
    // 31
    {
        ...
        method: [
            'Mix sauce. Cook chicken in oil, add sauce, simmer until sticky.'
        ]
    },
    // 32
    {
        ...
        method: [
            'Marinate ribs. Slow cook 2 hours. Finish on grill with extra sauce.'
        ]
    },
    // 33
    {
        ...
        method: [
            'Grill steaks. Sauté onions. Assemble sandwiches with cheese and sauce.'
        ]
    },
    // 34
    {
        ...
        method: [
            'Chop chicken, avocado, tomatoes, onion. Mix dressing. Toss and serve.'
        ]
    },
    // 35
    {
        ...
        method: [
            'Sauté onion, garlic. Add stock, potatoes. Simmer 20 min. Add seafood, cream. Cook 5 min.'
        ]
    },
    // 36
    {
        ...
        method: [
            'Cook pasta. Sauté mushrooms, garlic. Add cream, Parmesan, butter. Toss with pasta.'
        ]
    },
    // 37
    {
        ...
        method: [
            'Cook bacon and eggs. Toast rolls. Assemble with sauce.'
        ]
    },
    // 38
    {
        ...
        method: [
            'Sauté onion, spinach. Mix with feta, eggs. Fill pastry. Bake 200°C 30-35 min.'
        ]
    },
    // 39
    {
        ...
        method: [
            'Season beef. Brown. Place in slow cooker with vegetables, stock, herbs. Cook 4 hours.'
        ]
    },
    // 40
    {
        ...
        method: [
            'Parboil potatoes. Toss with garlic, herbs, oil. Roast 200°C 35-40 min until golden and crisp.'
        ]
    },
    // 41
    {
        ...
        method: [
            'Base: crush biscuits, mix with butter. Filling: beat cream cheese, cream, sugar. Fold in mango puree. Chill.'
        ]
    },
    // 42
    {
        ...
        method: [
            'Base: crush biscuits, mix with butter. Topping: beat sugar, passionfruit, coconut. Spread over base. Chill.'
        ]
    },
    // 43
    {
        ...
        method: [
            'Slice apples, place in dish. Mix flour, oats, butter, sugar, cinnamon. Sprinkle over apples. Bake 180°C 35-40 min.'
        ]
    },
    // 44
    {
        ...
        method: [
            'Cook dates in water. Cream butter, sugar. Add eggs. Fold in flour, baking soda, dates. Bake 180°C 30-35 min. Serve with caramel sauce.'
        ]
    },
    // 45
    {
        ...
        ingredients: [
            '4 chicken breasts',
            '2 tbsp lemon myrtle leaves',
            '2 garlic cloves',
            '1/4 cup olive oil',
            'Salt & pepper'
        ],
        method: [
            'Marinate chicken with lemon myrtle, garlic, oil, salt, pepper for 30 min. Grill or pan-fry 6-8 min each side.'
        ]
    },
    // 46
    {
        ...
        method: [
            'Season salmon. Grill 5-6 min each side. Serve with lemon and fresh herbs.'
        ]
    },
    // 47
    {
        ...
        method: [
            'Scramble eggs, set aside. Cook chicken, set aside. Sauté onion, carrots, peas. Add rice, soy sauce, chicken, egg. Toss to combine.'
        ]
    },
    // 48
    {
        ...
        method: [
            'Shred cabbage and carrots. Mix dressing. Toss to combine.'
        ]
    },
    // 49
    {
        ...
        method: [
            'Cook pasta. Sauté garlic, chilli, prawns. Toss with pasta, oil, lemon juice, parsley.'
        ]
    },
    // 50
    {
        ...
        method: [
            'Melt chocolate and butter. Add sugar, eggs, flour, macadamias. Bake 180°C 25-30 min.'
        ]
    }
];
...
function renderRecipes(recipes) {
    ...
    grid.innerHTML = recipes.map(recipe => `
        <div class="recipe-card" data-id="${recipe.id}">
            <img src="assets/images/${recipe.id}.png" alt="${recipe.title}" class="recipe-card-image" 
                 loading="lazy" 
                 onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22320%22 height=%22220%22%3E%3Crect fill=%22%23f5f1e8%22 width=%22320%22 height=%22220%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%238b5e3c%22 font-size=%2240%22%3E🍽️%3C/text%3E%3C/svg%3E'">
            <div class="recipe-card-content" onclick="openModal('${recipe.id}')">
...
function openModal(recipeId) {
    ...
    const tools = ['Wooden Spoon', 'Chef\'s Knife', 'Cutting Board'];
    ...
    body.innerHTML = `
        ...
        <img src="assets/images/${recipe.id}.png" alt="${recipe.title}" class="modal-image" 
             loading="lazy" 
             onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22700%22 height=%22280%22%3E%3Crect fill=%22%23f5f1e8%22 width=%22700%22 height=%22280%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%238b5e3c%22 font-size=%2260%22%3E🍽️%3C/text%3E%3C/svg%3E'">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:16px;">
            ...
            <button class="btn-secondary" onclick="toggleFavorite('${recipe.id}')" 
                    style="${isFavorite(recipe.id) ? 'background:#8B5E3C;color:white;' : ''}">
        ...
        <div style="margin-top:16px;padding:16px;background:#E9E1D5;border-radius:12px;">
            <h4 style="margin:0 0 8px;">🛠 Tools Used</h4>
            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                ${tools.map(t => `<span style="background:white;padding:4px 12px;border-radius:50px;font-size:13px;">${t}</span>`).join('')}
            </div>
        </div>
        ...
        <div style="margin-top:24px;">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-top:8px;">
                ${related.map(r => `
                    <div onclick="openModal('${r.id}')" style="cursor:pointer;background:var(--ivory);padding:12px;border-radius:12px;text-align:center;">
                        <div style="font-weight:500;font-size:13px;">${r.title}</div>
                        <div style="font-size:11px;color:var(--text-light);">${r.category}</div>
                    </div>
                `).join('')}
            </div>
        </div>
...
function startCookMode(recipeId) {
    const recipe = RECIPES.find(r => r.id === recipeId);
    if (!recipe) return;
    alert(`👨‍🍳 Cook Mode başlatıldı: ${recipe.title}\n\nAdımlar:\n${recipe.method.map((s,i) => `${i+1}. ${s}`).join('\n')}\n\n(Her adımı tamamladığınızda ilerleyin)`);
}
